...
public class PlayableRaceApiApiTest {
    ...
    public void getPlayableRaceByIdTest() throws ApiException {
        ...
        Integer raceId = null;
        String locale = null;
        PlayableRaceDTO response = api.getPlayableRaceById(namespace, region, raceId, locale);
    ...
    public void getPlayableRaceIndexTest() throws ApiException {
        ...
        String region = null;
        String locale = null;
        ArrayRacesIndexDTO response = api.getPlayableRaceIndex(namespace, region, locale);
