...
import fr.jbwittner.blizzardswagger.wowretailapi.model.ArrayRacesIndexDTO;
...
public class PlayableRaceApiApi {
     ...
     */
    public PlayableRaceDTO getPlayableRaceById(String namespace, String region, Integer raceId, String locale) throws ApiException {
        ApiResponse<PlayableRaceDTO> localVarResp = getPlayableRaceByIdWithHttpInfo(namespace, region, raceId, locale);
     ...
     */
    public ApiResponse<PlayableRaceDTO> getPlayableRaceByIdWithHttpInfo(String namespace, String region, Integer raceId, String locale) throws ApiException {
     ...
     */
    public okhttp3.Call getPlayableRaceByIdAsync(String namespace, String region, Integer raceId, String locale, final ApiCallback<PlayableRaceDTO> _callback) throws ApiException {
     ...
     */
    public ArrayRacesIndexDTO getPlayableRaceIndex(String namespace, String region, String locale) throws ApiException {
        ApiResponse<ArrayRacesIndexDTO> localVarResp = getPlayableRaceIndexWithHttpInfo(namespace, region, locale);
        return localVarResp.getData();
    }
     ...
     * @param region The region of the data to retrieve. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return ApiResponse&lt;ArrayRacesIndexDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ArrayRacesIndexDTO> getPlayableRaceIndexWithHttpInfo(String namespace, String region, String locale) throws ApiException {
        okhttp3.Call localVarCall = getPlayableRaceIndexValidateBeforeCall(namespace, region, locale, null);
        Type localVarReturnType = new TypeToken<ArrayRacesIndexDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getPlayableRaceIndexAsync(String namespace, String region, String locale, final ApiCallback<ArrayRacesIndexDTO> _callback) throws ApiException {
