...
public class PlayableSpecializationApiApi {
     ...
     */
    public PlayableRaceDTO getPlayableSpecializationById(String namespace, String region, Integer specId, String locale) throws ApiException {
        ApiResponse<PlayableRaceDTO> localVarResp = getPlayableSpecializationByIdWithHttpInfo(namespace, region, specId, locale);
     ...
     * @param specId The ID of the playable specialization. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return ApiResponse&lt;PlayableRaceDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PlayableRaceDTO> getPlayableSpecializationByIdWithHttpInfo(String namespace, String region, Integer specId, String locale) throws ApiException {
        okhttp3.Call localVarCall = getPlayableSpecializationByIdValidateBeforeCall(namespace, region, specId, locale, null);
        Type localVarReturnType = new TypeToken<PlayableRaceDTO>(){}.getType();
     ...
     */
    public okhttp3.Call getPlayableSpecializationByIdAsync(String namespace, String region, Integer specId, String locale, final ApiCallback<PlayableRaceDTO> _callback) throws ApiException {
     ...
     * @param region The region of the data to retrieve. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return ArraySpecializationsIndexDTO
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ArraySpecializationsIndexDTO getPlayableSpecializationIndex(String namespace, String region, String locale) throws ApiException {
        ApiResponse<ArraySpecializationsIndexDTO> localVarResp = getPlayableSpecializationIndexWithHttpInfo(namespace, region, locale);
        return localVarResp.getData();
    }
     ...
     * @param region The region of the data to retrieve. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return ApiResponse&lt;ArraySpecializationsIndexDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ArraySpecializationsIndexDTO> getPlayableSpecializationIndexWithHttpInfo(String namespace, String region, String locale) throws ApiException {
        okhttp3.Call localVarCall = getPlayableSpecializationIndexValidateBeforeCall(namespace, region, locale, null);
        Type localVarReturnType = new TypeToken<ArraySpecializationsIndexDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getPlayableSpecializationIndexAsync(String namespace, String region, String locale, final ApiCallback<ArraySpecializationsIndexDTO> _callback) throws ApiException {
     ...
     * @param specId The ID of the playable specialization. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return PlayableClassRaceMediaDTO
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public PlayableClassRaceMediaDTO getPlayableSpecializationMediaById(String namespace, String region, Integer specId, String locale) throws ApiException {
        ApiResponse<PlayableClassRaceMediaDTO> localVarResp = getPlayableSpecializationMediaByIdWithHttpInfo(namespace, region, specId, locale);
        return localVarResp.getData();
    }
     ...
     * @param specId The ID of the playable specialization. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return ApiResponse&lt;PlayableClassRaceMediaDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PlayableClassRaceMediaDTO> getPlayableSpecializationMediaByIdWithHttpInfo(String namespace, String region, Integer specId, String locale) throws ApiException {
        okhttp3.Call localVarCall = getPlayableSpecializationMediaByIdValidateBeforeCall(namespace, region, specId, locale, null);
        Type localVarReturnType = new TypeToken<PlayableClassRaceMediaDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getPlayableSpecializationMediaByIdAsync(String namespace, String region, Integer specId, String locale, final ApiCallback<PlayableClassRaceMediaDTO> _callback) throws ApiException {
