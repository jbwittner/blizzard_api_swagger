...
public class RealmApi {
     ...
     */
    public RealmData getRealm(String namespace, String region, String realmSlug, String locale) throws ApiException {
        ApiResponse<RealmData> localVarResp = getRealmWithHttpInfo(namespace, region, realmSlug, locale);
     ...
     */
    public ApiResponse<RealmData> getRealmWithHttpInfo(String namespace, String region, String realmSlug, String locale) throws ApiException {
     ...
     */
    public okhttp3.Call getRealmAsync(String namespace, String region, String realmSlug, String locale, final ApiCallback<RealmData> _callback) throws ApiException {
