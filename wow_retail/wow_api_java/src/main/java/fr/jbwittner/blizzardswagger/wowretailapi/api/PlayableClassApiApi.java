...
public class PlayableClassApiApi {
     ...
     */
    public PlayableClassDTO getPlayableClassById(String namespace, String region, Integer classId, String locale) throws ApiException {
        ApiResponse<PlayableClassDTO> localVarResp = getPlayableClassByIdWithHttpInfo(namespace, region, classId, locale);
     ...
     * @param classId The ID of the playable class. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return ApiResponse&lt;PlayableClassDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PlayableClassDTO> getPlayableClassByIdWithHttpInfo(String namespace, String region, Integer classId, String locale) throws ApiException {
        okhttp3.Call localVarCall = getPlayableClassByIdValidateBeforeCall(namespace, region, classId, locale, null);
        Type localVarReturnType = new TypeToken<PlayableClassDTO>(){}.getType();
     ...
     */
    public okhttp3.Call getPlayableClassByIdAsync(String namespace, String region, Integer classId, String locale, final ApiCallback<PlayableClassDTO> _callback) throws ApiException {
     ...
     */
    public ArrayClassesIndexDTO getPlayableClassIndex(String namespace, String region, String locale) throws ApiException {
        ApiResponse<ArrayClassesIndexDTO> localVarResp = getPlayableClassIndexWithHttpInfo(namespace, region, locale);
        return localVarResp.getData();
    }
     ...
     * @param region The region of the data to retrieve. (required)
     * @param locale The locale to reflect in localized data. (If you don&#39;t send a value, the API sends you all localized data) (optional)
     * @return ApiResponse&lt;ArrayClassesIndexDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ArrayClassesIndexDTO> getPlayableClassIndexWithHttpInfo(String namespace, String region, String locale) throws ApiException {
        okhttp3.Call localVarCall = getPlayableClassIndexValidateBeforeCall(namespace, region, locale, null);
        Type localVarReturnType = new TypeToken<ArrayClassesIndexDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getPlayableClassIndexAsync(String namespace, String region, String locale, final ApiCallback<ArrayClassesIndexDTO> _callback) throws ApiException {
     ...
     */
    public PlayableClassRaceMediaDTO getPlayableClassMediaById(String namespace, String region, Integer classId, String locale) throws ApiException {
        ApiResponse<PlayableClassRaceMediaDTO> localVarResp = getPlayableClassMediaByIdWithHttpInfo(namespace, region, classId, locale);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PlayableClassRaceMediaDTO> getPlayableClassMediaByIdWithHttpInfo(String namespace, String region, Integer classId, String locale) throws ApiException {
     ...
     */
    public okhttp3.Call getPlayableClassMediaByIdAsync(String namespace, String region, Integer classId, String locale, final ApiCallback<PlayableClassRaceMediaDTO> _callback) throws ApiException {
