...
------------- | ------------- | -------------
[**getPlayableClassById**](PlayableClassApiApi.md#getPlayableClassById) | **GET** /data/wow/playable-class/{classId} | 
[**getPlayableClassIndex**](PlayableClassApiApi.md#getPlayableClassIndex) | **GET** /data/wow/playable-class/index | 
[**getPlayableClassMediaById**](PlayableClassApiApi.md#getPlayableClassMediaById) | **GET** /data/wow/media/playable-class/{classId} | 


<a name="getPlayableClassById"></a>
# **getPlayableClassById**
> PlayableClassDTO getPlayableClassById(namespace, region, classId, locale)
...
import fr.jbwittner.blizzardswagger.wowretailapi.api.PlayableClassApiApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PlayableClassDTO result = apiInstance.getPlayableClassById(namespace, region, classId, locale);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlayableClassApiApi#getPlayableClassById");
...
[**PlayableClassDTO**](PlayableClassDTO.md)
...
> ArrayClassesIndexDTO getPlayableClassIndex(namespace, region, locale)
...
public class Example {
  public static void main(String[] args) {
    ...
    String locale = "en_US"; // String | The locale to reflect in localized data. (If you don't send a value, the API sends you all localized data)
    try {
      ArrayClassesIndexDTO result = apiInstance.getPlayableClassIndex(namespace, region, locale);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlayableClassApiApi#getPlayableClassIndex");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**ArrayClassesIndexDTO**](ArrayClassesIndexDTO.md)
...
> PlayableClassRaceMediaDTO getPlayableClassMediaById(namespace, region, classId, locale)
...
public class Example {
  public static void main(String[] args) {
    ...
    String locale = "en_US"; // String | The locale to reflect in localized data. (If you don't send a value, the API sends you all localized data)
    try {
      PlayableClassRaceMediaDTO result = apiInstance.getPlayableClassMediaById(namespace, region, classId, locale);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PlayableClassApiApi#getPlayableClassMediaById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
